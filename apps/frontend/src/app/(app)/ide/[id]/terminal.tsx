  ...
  return (
    ...
    >
      <div className="flex h-8 items-center justify-between border-b border-gray-4">
        ...
        <button
          onClick={addTab}
          className="hover:text-gray-12 flex size-7 items-center justify-center border-l border-gray-4 text-gray-11"
        >
...
function TermTab({
  ...
  return (
    ...
    >
      <Tabs.Trigger
        value={tab.id}
        className="hover:text-gray-12 aria-[selected=true]:text-gray-12 pl-4 text-gray-11"
      >
      ...
      <button className="hover:text-gray-12 flex size-7 items-center justify-center text-gray-11">
        <XIcon
