  ...
  return (
    <div className="flex size-full flex-col">
      ...
      <div className="flex items-center space-x-2 text-sm">
        <button
          className="hover:text-gray-12 flex h-6 w-full items-center justify-center space-x-2 text-gray-11 ring-inset hover:bg-sage-4 hover:ring-1 hover:ring-sage-9"
